...
/*   Updated: 2023/07/21 12:05:56 by otait-ta         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		int ray_id, double ray_angle)
{
	...
	ray_dist *= cos(ray_angle - mlx_info->player->rotation_angle);
